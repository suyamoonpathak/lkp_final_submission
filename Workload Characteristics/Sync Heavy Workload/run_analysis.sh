...
echo "============================================================"
echo "  Sync-Heavy Workload Journaling Mode Analysis"
...
read -rp "  Size per run, suffix k/m/g required (default: 100m): " SIZE
SIZE="${SIZE:-100m}"

read -rp "  Block sizes, space-separated, suffix k/m/g required (default: 4k 8k 16k 32k 64k): " BS_INPUT
...
WORKLOAD_FILE="$PROJECT_DIR/sync_heavy_workload.fio"
JOURNAL_SIZE_MB=64
...
for run_i in $(seq 1 "$N"); do
    ...
    echo ""
    echo "[5/5] Running sync-heavy workload: modes × block sizes..."
