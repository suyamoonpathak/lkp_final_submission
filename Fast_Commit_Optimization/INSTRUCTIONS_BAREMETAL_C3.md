...
Results save to `Fast_Commit_Optimization/eval_results_c3/baremetal/STOCK_<kernel>/`.
...
Results save to `Fast_Commit_Optimization/eval_results_c3/baremetal/PATCHED_<kernel>/`.
