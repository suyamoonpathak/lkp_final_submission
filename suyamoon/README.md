# Suyamoon Pathak (241110091) — FastCommit Coverage Extensions
...
bash suyamoon/build_char_helpers.sh
sudo bash suyamoon/eval_baremetal_c3.sh
# results land in suyamoon/eval_results_c3/baremetal/
```
...
# results land in suyamoon/eval_results_c4/baremetal/
```

### Run crash tests

```bash
sudo bash suyamoon/c3_crash_test_a.sh
sudo bash suyamoon/c3_crash_test_b.sh
sudo bash suyamoon/c3_crash_test_c.sh
sudo bash suyamoon/c4_crash_test_a.sh
sudo bash suyamoon/c4_crash_test_b.sh
sudo bash suyamoon/c4_crash_test_c.sh
